...
shinyServer(function(input, output, session) {
  ...
  observe({
    updateSelectInput(session, "custom_x", choices = names(selectedData()), selected = "flow")
    updateSelectInput(session, "custom_y", choices = names(selectedData()), selected = "final_count")
    updateSelectInput(session, "custom_color_by", choices = names(selectedData()), selected = "station_n")
    updateSelectInput(session, "facet_rows", choices = names(selectedData()))
    updateSelectInput(session, "facet_cols", choices = names(selectedData()), selected = "station_n")
  })
